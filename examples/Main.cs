...
var uri2 = AvatarUri.FromEmail("chrisf@ijw.co.nz", new AvatarOptions { UseSHA256 = true });
Console.WriteLine(uri2);

// 3. you can also use HTTPS
var uri3 = AvatarUri.FromEmail("chrisf@ijw.co.nz", new AvatarOptions { PreferHttps = true });
...
var uri4 = AvatarUri.FromEmail("chrisf@ijw.co.nz", favoriteOptions);
...
var uri6 = AvatarUri.FromEmail("chrisf@ijw.co.nz", new AvatarOptions { Size = 32 });
